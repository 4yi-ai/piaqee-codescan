...
func TestManagerDrivesJobToDone(t *testing.T) {
	...
	job, err := st.CreateJob(context.Background(), "job-done", store.SourceGit, "https://example.com/repo.git", "main")
	if err != nil {
...
func TestCancelBeforeStart(t *testing.T) {
	...
	job, err := st.CreateJob(context.Background(), "job-cancel", store.SourceGit, "https://example.com/repo.git", "release/test")
	if err != nil {
		t.Fatalf("create job: %v", err)
	}
